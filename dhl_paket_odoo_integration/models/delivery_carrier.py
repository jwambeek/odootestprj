...
class DeliveryCarrier(models.Model):
    ...
    services_name = fields.Selection([("V01PAK", "V01PAK-DHL PAKET"),
                                      ...
                                      ("V82PARCEL", "V82PARCEL-DHL PAKET International"),
                                      ("V62WP" ,"V62WP - DHL Warenpost")], string="Product Name",
    ...
    def api_attribute_formater(self, picking, to_address, total_weight, pack=False, shipment_order_node=False):
        ...
        etree.SubElement(address_detail, "cis:streetName").text = str(picking_company_id.street or "")
        ...
        etree.SubElement(address_detail, "cis:zip").text = str(picking_company_id.zip or "")
        etree.SubElement(address_detail, "cis:city").text = str(picking_company_id.city or "")
        ...
        if picking_company_id.phone:
            etree.SubElement(communication_node, "cis:phone").text = str(picking_company_id.phone or "")
        ...
        if to_address and picking.picking_type_id:
            ...
            if to_address.phone:
                etree.SubElement(communication, "cis:phone").text = str(to_address.phone or "")
            if to_address.email:
                etree.SubElement(communication, "cis:email").text = str(to_address.email or "")
            ...
            etree.SubElement(address_info, "cis:streetName").text = str(to_address.street or "")
            etree.SubElement(address_info, "cis:streetNumber").text = str(to_address.street_no or to_address.street2 or "")
            etree.SubElement(address_info, "cis:zip").text = str(to_address.zip or "")
            etree.SubElement(address_info, "cis:city").text = str(to_address.city or "")
